...
export default class RegisterController extends BaseController {
    ...
    public async register(ctx: IContext) {
        ...
        const verificationCode = ctx.request.body.reqData.verificationCode;
        ...
        const ip = address.ip;
        ctx.body = new BaseResponse(await this.service.register(account, verificationCode, password,
